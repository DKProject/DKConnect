...
final String RESOURCE_ID = "1e6d4f31-e2e0-11eb-8ba0-0242ac180002"

final String BRANCH_DEVELOPMENT = "development"
final String BRANCH_BETA = "beta"
final String BRANCH_MASTER = "master"

String PROJECT_NAME = "DKConnect"

boolean JAVADOCS_ENABLED = true
String JAVADOCS_NAME = "dkconnect"
String JAVADOCS_MODULES = ":DKConnect,:dkconnect-api"


def MIRROR_SERVER_PUBLISHING = [
        "dkconnect-minecraft/target/dkconnect-minecraft-%version%.jar": "default",
]
